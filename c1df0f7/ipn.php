...
$headers = array(
  'From: Hypothes.is <inbox@hypothes.is>'
);
...
if ($verified) {
    ...
    */
    ...
    if (strtolower(trim($_POST['payment_status'])) == 'completed') {
      $message = array();
...
Thank you for your generous donation to Hypothes.is!

Gifts like yours are what help us keep going. We appreciate them very much!

We hope you'll reserve your username http://hypothes.is, and follow our progress over the next year.

Thank you!
MESSAGE;

      mail($_POST['payer_email'], $message['subject'], $message['body'], implode("\r\n", $headers));
    }
    ...
    */
    ...
    $body = <<<MESSAGE
A invalid Paypal notification was sent. Please contact the site developer.
...
MESSAGE;
    ...
    mail('dwhaley@hypothes.is', 'Invalid IPN', $body, implode("\r\n", $headers));
}
