(function() {
  ...
  Tweet = (function() {
    ...
    Tweet.prototype.listItemClass = function(index, size) {
      if (index === 0) return this.options.firstClass;
      if (index === (size - 1)) return this.options.lastClass;
    };
    ...
    Tweet.apiUrl = function(options) {
      ...
      if (!options.hideRetweets) apiUrl += "&include_rts=1";
      apiUrl += "&callback=?";
      return apiUrl;
    };
  ...
  Time = (function() {
    ...
    Time.prototype.formatted = function() {
      if (this.format === "normal") return this.normalFormat();
